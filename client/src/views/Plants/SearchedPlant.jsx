        ...
        {this.state.loaded && (
          <>
            <div className="generalinfo">
              <img
                src={plant.images.fruit[0].image_url || plant.image_url}
                alt=""
              />
            ...
            <div className="structureinfo">
              {plant.flower.color && <h1>Structural</h1>}
              {plant.flower.color && (
                <h2>
              ...
              {plant.flower.conspicuous && (
                <p>
                  <strong>Conspicuous ? : </strong> {plant.flower.conspicuous}
                </p>
              )}
              ...
              {plant.foliage.foliage && (
                <p>
                  <strong>Texture: </strong> {plant.foliage.texture}
                </p>
              )}
              {plant.foliage.leaf_retention && (
                <p>
                  <strong>Leaf Retention: </strong>
                  {plant.foliage.leaf_retention}
                </p>
              )}
              ...
              {plant.fruit_or_seed.conspicuous && (
                <p>
                  <strong>Conspicuous ? : </strong>{' '}
                  {plant.fruit_or_seed.conspicuous}
                </p>
              )}
              {plant.fruit_or_seed.shape && (
                <p>
                  <strong>Shape: </strong> {plant.fruit_or_seed.shape}
                </p>
              )}
              {plant.fruit_or_seed.seed_persistence && (
                <p>
                  <strong>Seed Persistence: </strong>{' '}
                  {plant.fruit_or_seed.seed_persistence}
                </p>
              )}
              ...
              {plant.specifications.growth_rate && (
                <p>
              ...
              {plant.specifications.nitrogen_fixation && (
                <p>
                  <strong>Nitrogen Fixation:</strong>{' '}
                  {plant.specifications.nitrogen_fixation}
                </p>
              )}
              {plant.specifications.shape_and_orientation && (
                <p>
                  <strong>Shape and Orientation:</strong>{' '}
                  {plant.specifications.shape_and_orientation}
                </p>
              )}
              {plant.specifications.toxicity && (
                <p>
                  <strong>Toxicity:</strong> {plant.specifications.toxicity}
                </p>
              )}
            </div>

            <div className="growinfo">
              {plant.growth.fruit_months && <h1>Growth</h1>}
              {plant.growth.fruit_months && (
                <p>
                  <strong>Fruit months: </strong>
                  {plant.growth.fruit_months}
                </p>
              )}
              ...
              {plant.growth.ph_maximum && (
                <p>
                  <strong>Maximum pH: </strong>
                  {plant.growth.ph_maximum} / 14
                </p>
              )}
              {plant.growth.ph_minimum && (
                <p>
                  <strong>Minimum pH: </strong>
                  {plant.growth.ph_minimum}
                </p>
              )}
              {plant.growth.sowing && (
              ...
              {plant.growth.atmospheric_humidity && (
                <p>
                  ...
                  {plant.growth.atmospheric_humidity} / 10
                </p>
              )}
              {plant.growth.growth_months && (
                <p>
                  <strong>Growth months: </strong>
                  {plant.growth.growth_months}
                </p>
              )}
              {plant.growth.bloom_months && (
                <p>
                  <strong>Bloom months: </strong>
                  {plant.growth.bloom_months}
                </p>
              )}
            </div>
            ...
            <div className="additionalinfo">
              ...
              {plant.growth.minimum_precipitation.mm && (
                <p>
                  <strong>Minimum Precipitation: </strong>
                  {plant.growth.minimum_precipitation.mm} mm
                </p>
              )}
              {plant.growth.maximum_precipitation.mm && (
                <p>
                  <strong>Maximum Precipitation: </strong>
                  {plant.growth.maximum_precipitation.mm} mm
                </p>
              )}
              {plant.growth.minimum_root_depth.cm && (
                <p>
                  <strong>Minimum Root Depth: </strong>
                  {plant.growth.minimum_root_depth.cm}
                </p>
              )}
              {plant.growth.minimum_temperature.deg_f && (
                <p>
                  <strong>Minimum Temperature (Fahrenheit): </strong>
                  {plant.growth.minimum_temperature.deg_f} °F
                </p>
              )}
              {plant.growth.minimum_temperature.deg_c && (
                <p>
                  <strong>Minimum Temperature (Celsius): </strong>
                  {plant.growth.minimum_temperature.deg_c} °c
                </p>
              )}
              {plant.growth.maximum_temperature.deg_f && (
                <p>
                  <strong>Maximum Temperature (Fahrenheit): </strong>
                  {plant.growth.maximum_temperature.deg_f} °F
                </p>
              )}
              {plant.growth.maximum_temperature.deg_c && (
                <p>
                  <strong>Maximum Temperature (Celsius): </strong>
